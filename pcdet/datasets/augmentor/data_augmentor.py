...
class DataAugmentor(object):
    ...
    def gt_pts_imgs_sampling(self, config=None):
        db_pts_imgs_sampler = pts_imgs_db_sampler.PtsImgsDataBaseSampler(
            root_path=self.root_path,
            sampler_cfg=config,
            class_names=self.class_names,
            logger=self.logger
        )
        return db_pts_imgs_sampler
    
    def gt_pts_imgs_sampling_car(self, config=None):
        db_pts_imgs_sampler = pts_imgs_db_sampler_car.PtsImgsDataBaseSamplerCar(
            root_path=self.root_path,
            sampler_cfg=config,
            class_names=self.class_names,
            logger=self.logger
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        data_dict['random_world_flip_enable'] = enable
        return data_dict
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        gt_boxes, points, rot = augmentor_utils.global_rotation(
        ...
        data_dict['random_world_rotation'] = rot
        return data_dict
